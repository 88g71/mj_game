...
@Service(value="GuoPaiProcess")
public class GuoPaiProcess implements IProcessExtension{
	private static final String CMD = "guo";
	@Resource
	...
	public boolean process(Map<String, Object> msg) {
		if(CMD.equals(msg.get(MsgConstant.MSG_KEY_CMD))){
			...
			if(user != null){
				...
				tdhService.guo(roomTable, roomService.getUserSeat(roomTable, user));
			}
			return true;
		}
		return false;
