...
@Service(value="HuPaiProcess")
public class HuPaiProcess implements IProcessExtension{
	private static final String CMD = "hu";
	@Resource
	...
	public boolean process(Map<String, Object> msg) {
		if(CMD.equals(msg.get(MsgConstant.MSG_KEY_CMD))){
			...
			if(user != null){
				...
				tdhService.hu(roomTable, roomService.getUserSeat(roomTable, user));
			}
			return true;
		}
		return false;
